                  ...
                  picnic_privatekey_t* sk)
{
    ...
    SKINNYEnc((uint32_t*)pk->plaintext, (uint32_t*)pk->ciphertext, (uint32_t*)sk->data, &paramset);
...
int picnic_validate_keypair(const picnic_privatekey_t* privatekey, const picnic_publickey_t* publickey)
{
    ...
    SKINNYEnc((uint32_t*)publickey->plaintext, (uint32_t*)ciphertext, (uint32_t*)privatekey->data, &paramset);
